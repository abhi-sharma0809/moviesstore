"""
Django settings for Georgia Tech Movie Store project.
...
DEBUG = True  # Set to True for local testing, False for production

ALLOWED_HOSTS = ['abhisharma.pythonanywhere.com', '127.0.0.1', 'localhost']
